...
export default async function PhysicianPage() {
  ...
  const expertise = getActiveSection('expertise');
  const philosophy = getActiveSection('philosophy');
  const research = getActiveSection('research');
  const hours = getActiveSection('hours');
  const insurance = getActiveSection('insurance');
